...
\begin{document}%
    ...
    \DTLforeach*{abstracts}{\ID=submissionNumber,\title=title,\Authors=authors,\Institution=institution,\URL=previewurl,\pdf=pdf}{
      \begin{minipage}{\linewidth}
        \begin{flushleft}
          ...
          \hskip1pt\textcolor{blue}{\small \textbf{\title}}\\
          {\footnotesize \Authors}\\
          \textit{\footnotesize \Institution}\\
          \textcolor{blue}{\footnotesize
            \href{\URL}{\textbf{Abstract}} |
            \href{\pdf}{\textbf{Poster PDF}} |
            \href{https://firebasestorage.googleapis.com/v0/b/sparkle-ohbm.appspot.com/o/assets\%2Fcalendars\%2Fposters\%2Fposter\ID.ics?alt=media}{\textbf{Standby Times}} |
            \href{https://ohbm.sparkle.space/in/poster\ID}{\textbf{Visit poster}}
          }\\
        \end{flushleft}
        \vspace{10pt}
      \end{minipage}
  ...
  \begin{multicols}{3}
    ...
    \begin{flushleft}
      \setsepchar{,}
      \DTLloaddb[keys={last,first,submissionNumbers}]{index}{2021_authors_index.csv}
  ...
  \begin{multicols}{3}
    ...
    \begin{flushleft}
      \setsepchar{,}
      \DTLloaddb[keys={category,submissionNumbersC}]{indexC}{2021_categories_index.csv}
  ...
  \begin{multicols}{3}
    ...
    \begin{flushleft}
      \setsepchar{,}
      \DTLloaddb[keys={highlights,submissionNumbersH}]{indexH}{2021_abstract_highlights.csv}

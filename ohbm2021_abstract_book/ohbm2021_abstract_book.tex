...
\usepackage{datatool}
\DTLsetseparator{€}
\DTLloaddb[keys={submissionNumber,title,authors,institution,previewurl,pdf,video}]{abstracts}{2021_abstracts.csv}
...
\begin{document}%
  ...
  \begin{multicols}{2}
    \DTLforeach*{abstracts}{\ID=submissionNumber,\title=title,\Authors=authors,\Institution=institution,\URL=previewurl,\pdf=pdf,\video=video}{
